...
![Shields.io badge](https://img.shields.io/apm/v/terminalix.svg?style=flat-square)
...
From the moment of the terminal initialization a new atom command is created - `terminalix:test`,
...
```json
{
	"_comment": "Package terminalix: This terminal-commands.json file was automatically generated by atom-terminal-package. It contains all useful config data.",
	"commands": {
		"hello_world": {
